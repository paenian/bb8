...
openscad -o printing/rightgear.stl -D part=4 -D textured=true -D angle=0 -D mirror=1 -D assembled=false -D facets=360 sphere2.scad &

openscad -o printing/leftmotor_carrier.stl -D part=3 -D textured=true -D angle=0 -D assembled=false -D facets=360 sphere2.scad &
openscad -o printing/rightmotor_carrier.stl -D part=3 -D textured=true -D angle=0 -D mirror=1 -D assembled=false -D facets=360 sphere2.scad &
